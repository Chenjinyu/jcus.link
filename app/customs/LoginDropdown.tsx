            ...
            <div className="space-y-3">
              <button
                ...
                className="
                    w-full flex items-center justify-center gap-3
                    px-4 py-3 rounded-lg 
                    font-medium text-smw-full text-center text-sm font-medium opacity-70 hover:opacity-100 transition-opacity
                    hover:bg-[#737475] hover:font-bold hover:text-black
                "
                style={{ color: navbarText }}
              >
                <CircleUser />
                <span className="text-sm whitespace-nowrap">Continue as Guest</span>
              </button>
              </div>
            </div>
          </div>
